...
entity fir_to_fft_C_data_V_ram is 
    generic(
...
architecture rtl of fir_to_fft_C_data_V_ram is 
...
architecture arch of fir_to_fft_C_data_V is
    component fir_to_fft_C_data_V_ram is
        port (
            clk : IN STD_LOGIC;
...
begin
    fir_to_fft_C_data_V_ram_U :  component fir_to_fft_C_data_V_ram
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
